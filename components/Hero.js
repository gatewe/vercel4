export default function Hero() {
  return (
    <div className="max-w h-[500px] overflow-hidden rounded-lg border border-gray-200 bg-opacity-0 bg-[url('/static/hackers-resized-min-light2.svg')] bg-bottom shadow-[0_0_12px_rgba(0,0,0,0.6)] shadow-fuchsia-600/40 dark:shadow-fuchsia-400/20 dark:border-gray-700 dark:bg-[url('/static/hackers-resized-min-dark.svg')]">
