export default function Hero() {
  return (
    <div className="max-w h-[500px] overflow-hidden rounded-lg border border-gray-200 bg-opacity-0 bg-[url('/static/hackers-resized-min-light.svg')] bg-bottom shadow-[0_0_12px_rgba(0,0,0,0.6)] shadow-fuchsia-400/20 dark:border-gray-700 dark:bg-[url('/static/hackers-resized-min-dark.svg')]">
      ...
      <div className="min-w-screen m-4 grid basis-full items-center justify-center">
        <div className="flex flex-col items-start justify-between xl:flex-row">
          <div className="flex flex-col text-4xl sm:text-5xl md:text-6xl">
            <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text font-semibold uppercase text-transparent">
              Welcome to Compaas!
            </span>
